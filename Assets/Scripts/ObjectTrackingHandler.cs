...
{
    private static string _trackedObjectName;
    ...
    public static string GetTrackedObjectName()
    {
        return _trackedObjectName;
    }
    
    public static void SetTrackedObjectName(string objName)
    {
        _trackedObjectName = objName;
    }
    ...
    protected virtual void OnTrackingFound()
    {
        ...
        _trackedObjectName = mObserverBehaviour.TargetName;
        Debug.Log("Target Name: " + _trackedObjectName);
